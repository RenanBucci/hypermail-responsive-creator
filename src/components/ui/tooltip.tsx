...
// Enhanced hover card tooltip for richer content
const RichTooltipTrigger = React.forwardRef<
...
export { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider, RichTooltipTrigger, RichTooltipContent }
